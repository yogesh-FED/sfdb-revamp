...
const get_pds_transaction =  async (family_id) => {
        ...
        //         console.log(response?.data?.pds_data?.transactionData);
        //       }
        //       else{
        //         // console.log(response.messeage);
        //       }
      ...
      <table>
        ...
        <tbody>
                    ...
                    <tr>
                        ...
                        <td class="label-cell">${list.product_id}</td>
                        <td class="numeric-cell">${list.distributed_quanitity}</td>
                       
                    </tr>`;  // Return each item wrapped in <p> tags
                        }).join('')}  <!-- Join to create a single string from the list items -->
